...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        try:
            ...
            await message.reply_text("Something's not right ..!")
            return
...
async def not_joined(client: Client, message: Message):
    text = "<b>You must join a channel/Group to use me\n\nPlease join the Channel</b>"
    message_text = message.text
    try:
        command, argument = message_text.split()
        text = text + f" <b>If you haven't joined, you can't open the file. If you've joined, please click refresh</b>"
    except ValueError:
        pass
