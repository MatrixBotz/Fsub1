...
async def channel_post(client: Client, message: Message):
    ...
    try:
        ...
        print(e)
        await reply_text.edit_text("Looks like something went wrong..!")
        return
    ...
    await reply_text.edit("Your link is ready", reply_markup=reply_markup, disable_web_page_preview = True)
